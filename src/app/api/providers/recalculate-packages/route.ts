 ...
 *
 * POST /api/providers/recalculate-packages        — recalculate all packages for provider
 * POST /api/providers/recalculate-packages?clientPackageId=xxx — single package
 */
